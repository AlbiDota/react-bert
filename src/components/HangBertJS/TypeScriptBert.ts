namespace TypeScriptBert {
    ...
    let currentScore : number = 0; // Number
    let userName : string = "Bert"; // String
    let userAge : number = 25; // Number
    let newUser : boolean = true; // Boolean
    ...
    let MAX_SCORE_DIVIDED = MAX_SCORE / 10; // Division
    let MAX_SCORE_MODULUS = MAX_SCORE % 3; // Modulus
    console.log(
        "-------------------------" +
    ...
    console.log("-------------------------");
    let coolArray = ["TypeBert", 25, false, new Date("2025-02-11"), {name: "Bert", age: 25}]; // Array of 5 different data types: String, Number, Boolean, Date, Object
